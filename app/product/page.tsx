...
export default function ProductsPage() {
  ...
  const products: Product[] = [
    ...
    },
    {
      ...
      subCategory: 'CPAP',
      price: 6000,
      image: '/images/products/philips-dreamstation.jpg',
      tag: 'CPAP',
      rating: 4.8,
      reviews: 42,
      inStock: true
    },
    {
      ...
      subCategory: 'CPAP',
      price: 8000,
      image: '/images/products/bmc-02-cpap.jpg',
      tag: 'CPAP',
      rating: 4.2,
      reviews: 19,
      inStock: true
    },
    {
      ...
      subCategory: 'CPAP',
      price: 15000,
      image: '/images/products/resmed-airsense-10.jpg',
      tag: 'CPAP',
      rating: 4.9,
      reviews: 56,
      inStock: true
    ...
    {
      id: 6,
      name: 'Venturi VN-830 BiPAP',
      description: 'BiPAP Machine with ST mode',
      category: 'BiPAP Machines',
      subCategory: 'BiPAP',
      price: 5000,
      image: '/images/products/venturi-vn830.jpg',
      tag: 'BiPAP',
      rating: 4.3,
      reviews: 17,
      inStock: true
    ...
    {
      id: 7,
      name: 'Philips BiPAP A40',
      description: 'Advanced BiPAP with AVAPS technology',
      category: 'BiPAP Machines',
      subCategory: 'BiPAP',
      price: 35000,
      image: '/images/products/philips-bipap-a40.jpg',
      tag: 'BiPAP',
      rating: 4.7,
      reviews: 31,
      inStock: true
    ...
    // Masks
    {
      ...
      subCategory: 'Masks',
      price: 3000,
      image: '/images/products/resmed-airfit-f20.jpg',
      tag: 'Mask',
      rating: 4.6,
      reviews: 38,
      inStock: true
    },
    {
      ...
      subCategory: 'Masks',
      price: 2500,
      image: '/images/products/philips-dreamwear.jpg',
      tag: 'Mask',
      rating: 4.4,
      reviews: 27,
      inStock: true
    ...
    {
      id: 10,
      name: 'Fisher & Paykel Simplus',
      description: 'Full face mask with roll-fit cushion',
      category: 'CPAP / BiPAP Masks',
      subCategory: 'Masks',
      price: 2800,
      image: '/images/products/fisher-paykel-simplus.jpg',
      tag: 'Mask',
      rating: 4.3,
      reviews: 22,
      inStock: true
    ...
    // Accessories
    {
      ...
      subCategory: 'Tubing',
      price: 800,
      image: '/images/products/cpap-tubing.jpg',
      tag: 'Accessory',
      rating: 4.1,
      reviews: 45,
      inStock: true
    },
    {
      ...
      price: 1200,
      image: '/images/products/humidifier-chamber.jpg',
      tag: 'Accessory',
      rating: 4.2,
      reviews: 33,
      inStock: true
    },
    {
      ...
      subCategory: 'Filters',
      price: 350,
      image: '/images/products/bacterial-filter.jpg',
      tag: 'Filter',
      rating: 4.0,
      reviews: 29,
      inStock: true
    },
    {
      ...
      price: 600,
      image: '/images/products/headgear-strap.jpg',
      tag: 'Accessory',
      rating: 4.1,
      reviews: 26,
      inStock: true
    ...
    // Oxygen Concentrators
    {
      ...
      subCategory: 'Oxygen',
      price: 4500,
      image: '/images/products/oxygen-concentrator-5l.jpg',
      tag: 'Oxygen',
      rating: 4.5,
      reviews: 41,
      inStock: true
    },
    {
      ...
      subCategory: 'Oxygen',
      price: 7500,
      image: '/images/products/oxygen-concentrator-10l.jpg',
      tag: 'Oxygen',
      rating: 4.6,
      reviews: 34,
      inStock: true
    ...
    // Nebulizers
    {
      ...
      price: 1800,
      image: '/images/products/nebulizer-compressor.jpg',
      tag: 'Nebulizer',
      rating: 4.3,
      reviews: 52,
      inStock: true
    },
    {
      ...
      subCategory: 'Nebulizer',
      price: 2500,
      image: '/images/products/ultrasonic-nebulizer.jpg',
      tag: 'Nebulizer',
      rating: 4.4,
      reviews: 38,
      inStock: true
    ...
    },
    {
      ...
      subCategory: 'Monitor',
      price: 15000,
      image: '/images/products/baby-oximeter.jpg',
      tag: 'Monitor',
      rating: 4.5,
      reviews: 23,
      inStock: true
    ...
    },
    {
      ...
      subCategory: 'Oximeter',
      price: 2200,
      image: '/images/products/wrist-oximeter.jpg',
      tag: 'Oximeter',
      rating: 4.0,
      reviews: 31,
      inStock: true
    ...
    // Ventilators
    {
      ...
      price: 85000,
      image: '/images/products/icu-ventilator.jpg',
      tag: 'Ventilator',
      rating: 4.8,
      reviews: 14,
      inStock: true
    },
    {
      ...
      subCategory: 'Ventilator',
      price: 45000,
      image: '/images/products/portable-ventilator.jpg',
      tag: 'Ventilator',
      rating: 4.4,
      reviews: 18,
      inStock: true
    ...
    // Thermometers
    {
      ...
      price: 25000,
      image: '/images/products/ear-thermometer.jpg',
      tag: 'Thermometer',
      rating: 4.3,
      reviews: 42,
      inStock: true
